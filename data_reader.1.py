...
if __name__ == "__main__":
    ...
    # data_path = "/home/tq/data_pool/zgq/test_vortex/PE/td_all.npy"
    ...
    all_train, all_test = split_data(all_data, 0.5)
    all_hard, all_soft = split_data(all_train, 0.15)
    ...
    # all_hard = delete_label(all_hard, [2, 1, 6])
    # hard, hard_label = strip_labels(all_hard)
    # print(hard.shape)
